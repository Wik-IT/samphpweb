...
SET TIMEZONE
	...
	For correct options see: https://www.php.net/manual/en/timezones.php
*/
//date_default_timezone_set('America/New_York');
...
## ======================================== ##
define('STATION_NAME', 'Pink Radio Station');
define('STATION_LOGO', 'images/logo.png');
define('STATION_LISTEN', 'https://radio.pinkie.ro/stream'); //The URL to the player or playlist file (*.pls, *.m3u)
define('STATION_EMAIL', 'dj@pinkie.ro'); //Leave blank if you do not wish to publish your email address!
...
SAM_HOST
	...
	Try https://www.ipchicken.com or https://www.whatismyip.com
	If your IP address changes regularly, rather use DNS to make the "name" static.
	See https://www.no-ip.com and https://www.dyndns.com/
*/
define('SAM_HOST', '10.0.1.2');
...
PICTURE_URL
	...
	Example Absolute path: https://your.webserver.com/pictures/
 */
