...
if ($station_listen == 'https://example.com/playlist.m3u') {
	$err_message[] = 'Station Listen URL not set. Please change listen link or alternatively leave it blank to disable.';
}

$station_email = constant('STATION_EMAIL');
if ($station_email == 'email@mailbox.com') {
