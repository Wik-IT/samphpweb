...
class Song {
	...
	public static function getComingSongs() {
		$db = Database::getInstance();
                ...
                // Make sure we are allowed to display coming up songs
	...
	protected function set_buycd($song) {
		if (empty($song['BUYCD'])) {
			$data = 'https://www.amazon.com/s?k=#artist#%20#title#%20#album#';
	...
	protected function set_website($song) {
		...
		if (empty($song['WEBSITE'])) {
			$data = 'https://www.google.com/search?q=#artist#%20#title#%20#album#';
