						...
						<tbody>
							<tr>
								<td align="center"><br>
									...
									<a href="<?php echo $currentSong->buycd; ?>" target="_blank">
								...
								<td colspan="2">
									<span id="currently-playing-title"><?php echo $currentSong->title; ?></span><?php if ($currentSong->isRequested) echo " ~requested~ "; ?>
									<?php if(!empty($currentSong->artist)) : ?><br />by <span id="currently-playing-artist"><a href="<?php echo $currentSong->website; ?>" target="_blank"><?php echo $currentSong->artist; ?></a></span> <?php endif; ?>
									<?php if(!empty($currentSong->album)) : ?><br />from <span id="currently-playing-artist"><a href="<?php echo $currentSong->buycd; ?>" target="_blank"><?php echo $currentSong->album; ?></a></span><?php endif; ?>
