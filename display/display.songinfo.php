	...
	<body>
		...
		<div id="page">
			...
			<dl>
				...
				<dt>Artist</dt>
				<dd><a href="<?php echo $song->website; ?>" target="_blank" title="Click for more Artist info"><?php echo $song->artist; ?></a></dd>
				<dt>Album</dt>
				<dd><a href="<?php echo $song->buycd; ?>" target="_blank" title="Click for more Album info"><?php echo $song->album; ?></a></dd>
				<dt>Duration</dt>
